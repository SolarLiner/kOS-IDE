...
[assembly: AssemblyVersion("0.34.*")] // Remember to change that at next release.
    ...
    public partial class TextEditor : Form
    {
        ...
        string filename
        {
            ...
            set
            {
                ...
                try
                {
                    if (value == null) TextEditor.ActiveForm.Text = "kOS IDE v" + version + " - Unknown";
                    else TextEditor.ActiveForm.Text = "kOS IDE v"+version+" - " + value;
                }
                catch { }
            }
        }
        ...
        void InitAutoComplete()
        {
            ...
            string[] args1 = // Lazy stuff here, to get the "?" imaging stuff done.
            ...
            string[] args3 =
            { "throttle", "steering", "wheelthrottle", "wheelsteering", "brakes", "gear", "lights", "rcs", "sas", "target", "altitude", "alt",
                ...
                "retrograde", "up", "body", "mass", "maxthrust", "status", "stage", "target", "vesselname"};
            ...
            Subitems = new List<string>(new string[] {"distance?2", "apoapsis?2", "periapsis?2", "up?2", "pitch?2", "yaw?2", "roll?2"});
            KeysAndVars.Sort();
            Subitems.Sort();
        }
        ...
        public TextEditor()
        {
            ...
            Editor.Lexing.SetKeywords(0, "set to print until if switch copy from delete declare edit list lock on off rename run toggle unlock wait when R VESSEL abs sin cos tan arcsin arccos arctan arctan2");
            Editor.Lexing.SetKeywords(1, "target break clearscreen reboot shutdown stage all vesselname altitude radar body missiontime velocity verticalspeed surfacespeed latitude longitude status mass maxthrust prograde retrograde up pitch yaw roll name distance apoapsis periapsis alt eta node mag liquidfuel oxidizer sas gear rcs lights brakes abort ag1 ag2 ag3 ag4 ag5 ag6 ag7 ag8 ag9 ag10 throttle steering wheelthrottle wheelsteering angularmomentum angularvel surfacespeed verticalspeed facing geoposition");
